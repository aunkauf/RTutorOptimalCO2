...
info("TI and CI") # Run this line (Strg-Enter) to show info
...
```{r "2___Exempted_Firms__5",results='asis'}
library(stargazer)
...
```{r "2___Exempted_Firms__12",results='asis'}
...
```{r "2___Exempted_Firms__14",results='asis'}
...
```{r "2___Exempted_Firms__20",optional=TRUE}
...
```{r "2_1___Graphical_appr__9",results='asis'}
...
```{r "2_1___Graphical_appr__11",optional=TRUE}
# Enter your command here
```


#! addon__quiz__Quiz 2.1
...
```{r "3___Vulnerability_sc__3",results='asis'}
...
```{r "3___Vulnerability_sc__7",results='asis'}
...
```{r "3___Vulnerability_sc__11",results='asis'}
# Enter your code here
# 
...
```{r "3___Vulnerability_sc__15",results='asis'}
# Filter the data
...
```{r "3___Vulnerability_sc__16",optional=TRUE}
# Enter your command here
```
...
```{r "5___Exploring_the_Re__3",results='asis'}
...
```{r "5___Exploring_the_Re__10",results='asis'}
# Uncomment the code lines and fill out the "???"
...
```{r "5___Exploring_the_Re__11",results='asis'}
...
```{r "5___Exploring_the_Re__12",results='asis'}
...
```{r "5___Exploring_the_Re__13",optional=TRUE}
# Enter your command here
```

...
```{r "2_Exempted_Firms__11",results='asis'}
library(stargazer)
...
```{r "3_Vulnerability_scor__3",results='asis'}
...
```{r "3_Vulnerability_scor__7",results='asis'}
...
```{r "3_Vulnerability_scor__11",results='asis'}
# Enter your code here
# 
# and add afterwards 
...
```{r "5_Exploring_the_Resu__3",results='asis'}
...
```{r "5_Exploring_the_Resu__10",results='asis'}
# Uncomment the code lines and fill out the "???"
...
```{r "5_Exploring_the_Resu__11",results='asis'}
...
```{r "5_Exploring_the_Resu__12",results='asis'}

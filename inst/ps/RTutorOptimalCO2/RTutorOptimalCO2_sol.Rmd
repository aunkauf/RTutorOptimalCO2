...
libs = c("ggplot2","foreign","dplyr","yaml","dplyr","stargazer") # character vector of all packages you load in the problem set
...
display(" ")
#>
Ex1.1=summarize(classification,firm=sum(oneOsum),employees=sum(empOsum),emission=sum(surrOsum))
```
...
#>
#< hint
display("Look at your previous plot, it's nearly the same. And just a little coord flip at the end ")
#>
...
#>
#< hint
display("emp.allo=summarize(optimal,risk.firm=...,risk.sector=...) Now fill out the ... ")
#>
